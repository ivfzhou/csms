...
func newTodo(db *gorm.DB, opts ...gen.DOOption) todo {
	...
	_todo.AppID = field.NewInt(tableName, "app_id")
	_todo.Type = field.NewInt(tableName, "type")
	_todo.ApplierID = field.NewInt(tableName, "applier_id")
	_todo.ApproverID = field.NewInt(tableName, "approver_id")
	_todo.Candidates = field.NewField(tableName, "candidates")
	_todo.ApplyReason = field.NewString(tableName, "apply_reason")
	_todo.ApproveMessage = field.NewString(tableName, "approve_message")
	_todo.Information = field.NewString(tableName, "information")
	_todo.Status = field.NewInt(tableName, "status")
	_todo.CreatedTime = field.NewTime(tableName, "created_time")
	_todo.FinishedTime = field.NewTime(tableName, "finished_time")
...
type todo struct {
	...
	Type           field.Int    // 类型，见表 3-4
	ApplierID      field.Int    // 申请人 ID
	ApproverID     field.Int    // 审批人 ID
	Candidates     field.Field  // 待办可审批的人 ID，英文逗号分隔
	ApplyReason    field.String // 申请理由
	ApproveMessage field.String // 审批语
	Information    field.String // 审批对象信息
	Status         field.Int    // 状态，1=待处理、2=驳回、3=同意
...
func (t *todo) updateTableName(table string) *todo {
	...
	t.AppID = field.NewInt(table, "app_id")
	t.Type = field.NewInt(table, "type")
	t.ApplierID = field.NewInt(table, "applier_id")
	t.ApproverID = field.NewInt(table, "approver_id")
	t.Candidates = field.NewField(table, "candidates")
	t.ApplyReason = field.NewString(table, "apply_reason")
	t.ApproveMessage = field.NewString(table, "approve_message")
	t.Information = field.NewString(table, "information")
	t.Status = field.NewInt(table, "status")
	t.CreatedTime = field.NewTime(table, "created_time")
	t.FinishedTime = field.NewTime(table, "finished_time")
...
func (t *todo) fillFieldMap() {
	...
	t.fieldMap["applier_id"] = t.ApplierID
	t.fieldMap["approver_id"] = t.ApproverID
	t.fieldMap["candidates"] = t.Candidates
	t.fieldMap["apply_reason"] = t.ApplyReason
	t.fieldMap["approve_message"] = t.ApproveMessage
	t.fieldMap["information"] = t.Information
	t.fieldMap["status"] = t.Status
	t.fieldMap["created_time"] = t.CreatedTime
	t.fieldMap["finished_time"] = t.FinishedTime
}
