...
func newNotice(db *gorm.DB, opts ...gen.DOOption) notice {
	...
	_notice.ID = field.NewInt(tableName, "id")
	_notice.Content = field.NewString(tableName, "content")
	_notice.UserID = field.NewInt(tableName, "user_id")
	_notice.ExpiredTime = field.NewTime(tableName, "expired_time")
	_notice.ActivatedTime = field.NewTime(tableName, "activated_time")
	_notice.CreatedTime = field.NewTime(tableName, "created_time")
...
func (n *notice) updateTableName(table string) *notice {
	...
	n.UserID = field.NewInt(table, "user_id")
	n.ExpiredTime = field.NewTime(table, "expired_time")
	n.ActivatedTime = field.NewTime(table, "activated_time")
...
func (n *notice) fillFieldMap() {
	...
	n.fieldMap["expired_time"] = n.ExpiredTime
	n.fieldMap["activated_time"] = n.ActivatedTime
