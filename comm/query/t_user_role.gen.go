...
func newUserRole(db *gorm.DB, opts ...gen.DOOption) userRole {
	...
	_userRole.ID = field.NewInt(tableName, "id")
	_userRole.AppID = field.NewInt(tableName, "app_id")
	_userRole.UserID = field.NewInt(tableName, "user_id")
	_userRole.Role = field.NewInt(tableName, "role")
...
type userRole struct {
	...
	UserID field.Int // 用户 ID
	Role   field.Int // 角色，1=系统运营员、2=应用管理员、3=应用成员、4=可使用签名服务
...
func (u *userRole) updateTableName(table string) *userRole {
	...
	u.AppID = field.NewInt(table, "app_id")
