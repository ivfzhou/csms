...
// AppleWebStatisticSigningTimesReq 获取应用的 Apple 类型签名次数统计信息请求体。
type AppleWebStatisticSigningTimesReq struct {
	// 应用 ID
...
// AppleWebStatisticSigningTimesRsp 获取应用的 Apple 类型签名次数统计信息响应体。
type AppleWebStatisticSigningTimesRsp struct {
	// 数据
	List []*AppleWebStatisticSigningTimesItem `json:"list,omitempty"`
}

// AppleWebStatisticSigningTimesItem 签名次数信息。
type AppleWebStatisticSigningTimesItem struct {
	// 开始时间
	BeginTime string `json:"beginTime,omitempty"`
	// 签名次数
	SigningTimes int `json:"signingTimes,omitempty"`
}

// AppleWebStatisticSigningCostReq 获取应用的 Apple 类型签名耗时统计信息请求体。
type AppleWebStatisticSigningCostReq struct {
	// 应用 ID
	AppID string `form:"appId" binding:"omitempty,len=32,alphanum" example:"4ef83c03e2ce4f1f94c11168d1acd087"`
	// 开始时间
	BeginTime time.Time `form:"beginTime" time_format:"2006-01-02" binding:"required" example:"2024-01-01"`
...
// AppleWebStatisticSigningCostRsp 获取应用的 Apple 类型签名耗时统计信息响应体。
type AppleWebStatisticSigningCostRsp struct {
	// 数据
	List []*AppleWebStatisticSigningCostItem `json:"list,omitempty"`
}

// AppleWebStatisticSigningCostItem 签名耗时信息。
type AppleWebStatisticSigningCostItem struct {
	// 开始时间
	BeginTime string `json:"beginTime,omitempty"`
	// 签名耗时
...
func initAppleWebProtocol() {
	...
	validator.AddTranslationMessage(reflect.TypeFor[AppleWebStatisticSigningTimesReq](), validator.TranslationMessage{
		"AppID": {
			"len": {
